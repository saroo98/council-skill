...
- Made the README overview compact and removed extra visual sections from the top graphic.
- Inlined the README logo SVG so it renders reliably on GitHub.
